var url = "https://solucionesaiapps.com/api/cars/";
var urlImage = "https://solucionesaiapps.com/";
...
jQuery(function($) {
    $("#botonComprobar").click(function(e) {
        ...
        if(seleccion.email=='') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#finalResultModal').css('opacity', '1');
                },
...
function getVersions() {
    jQuery(function($) {
        ...
        $.ajax({
            url: url + "car/?model_id="+seleccion.modelo.id+"&year="+seleccion.anyo.anyo+"&enginetype="+15+"&cv_id="+seleccion.potencia+"&apikey=" + apikey,
            type: "GET",
            beforeSend: function() {
...
function getPowers() {
    jQuery(function($) {
        ...
        $.ajax({
            url: url + "cv/?model_id="+seleccion.modelo.id+"&year="+seleccion.anyo.anyo+"&enginetype="+15+"&apikey=" + apikey,
            type: "GET",
            beforeSend: function() {
...
function getAutocaravanasBrands() {
    jQuery(function($){
        // OBTENER APIKEY & EMAIL
        debugger;
        apikey = $('#hiddenApikeyAutocaravanas').val();
        email_webmaster = $('#hiddenEmail').val();
        if(apikey != undefined) {
            $.ajax({
                url: url + "brands/?version=" + version + "&apikey=" + apikey + "&mobile_home=1",
                type: "GET",
                beforeSend: function () {
                    $("#brandLoader").fadeIn("slow");
                    $("#buttonRetry").addClass('hide');
                    $("#buttonRetry").removeClass('show');
                },
                complete: function () {
                    $("#brandLoader").hide();
                },
